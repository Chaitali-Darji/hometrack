            ...
            <div class="card-header">
              ...
              <div class="card-title w100">
                <div class="row">
                  ...
                  <div class="col-md-6"><a href="{{route('sales-tax.create')}}" class="btn btn-primary pull-right">Add</a></div>
                </div>
              </div>
            </div>
            <div class="card-body">
                            ...
                            @foreach($salestaxes as $salestax)
                              <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('sales-tax.destroy',$salestax->id)}}" data-salestaxid="{{$salestax->id}}" class="delete-confirm">
                                        <i class="bx bx-trash mr-1"></i>
                                    </a>

                                    <div class="custom-control custom-switch custom-switch-success mr-2 mb-1" style="display: inline-block;">
                                      <input type="checkbox" class="custom-control-input active-salestax" data-salestaxid= "{{$salestax->id}}" id="customSwitchcolor{{$salestax->id}}" data-url="{{route('admin.sales-tax.active-inactive',$salestax->id)}}" @if($salestax->is_active) checked @endif>
                                      <label class="custom-control-label" for="customSwitchcolor{{$salestax->id}}" ></label>
                                    </div>
