                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <fieldset class="form-group">
                                                ...
                                                {!! Form::text('email_template[name]', isset($email_template) ? $email_template->name : null, array('class' => 'form-control required')) !!}
                                            ...
                                            <fieldset class="form-group">
                                                ...
                                                {!! Form::text('email_template[description]', isset($email_template) ? $email_template->description : null, array('class' => 'form-control required')) !!}
                                            ...
                                            <fieldset class="form-group">
                                                ...
                                                {!! Form::text('email_template[subject]', isset($email_template) ? $email_template->subject : null, array('class' => 'form-control required')) !!}
                                            ...
                                            <fieldset class="form-group">
                                                ...
                                                {!! Form::select('email_template[from]', $users,isset($email_template) ? $email_template->from : null, array('class' => 'form-control required')) !!}
                                            ...
                                            <fieldset class="form-group">
                                                {!! Form::label('bcc', 'BCC:') !!}
                                                {!! Form::select('email_template[bcc]', $users,isset($email_template) ? $email_template->bcc : null, array('class' => 'form-control required')) !!}
