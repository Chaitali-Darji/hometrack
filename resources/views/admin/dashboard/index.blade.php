                ...
                <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="d-flex justify-content-between align-items-end">
                            ...
                            <img src="{{asset('admin/images/icon/cup.png')}}" height="220" width="220" class="img-fluid"
                            ...
                            <table class="table table-borderless widget-earnings-width mb-0">
                                ...
                                <tr>
                                    ...
                                    <div class="media align-items-center">
                                        ...
                                        <img src="{{asset('admin/images/portrait/small/avatar-s-10.jpg')}}" alt="avatar"
                                ...
                                <tr>
                                    ...
                                    <div class="media align-items-center">
                                        <a class="media-left mr-50" href="javascript:;">
                                        <img src="{{asset('admin/images/portrait/small/avatar-s-11.jpg')}}" alt="avatar"
                                            class="rounded-circle" height="30" width="30">
                                        </a>
                                        <div class="media-body">
                                ...
                                <tr>
                                    ...
                                    <div class="media align-items-center">
                                        <a class="media-left mr-50" href="javascript:;">
                                        <img src="{{asset('admin/images/portrait/small/avatar-s-12.jpg')}}" alt="avata"
                                            class="rounded-circle" height="30" width="30">
                                        </a>
                                        <div class="media-body">
                        ...
                        <div class="wrapper-content" data-earnings="laravel-temp">
                            ...
                            <table class="table table-borderless widget-earnings-width mb-0">
                                ...
                                <tr>
                                    ...
                                    <div class="media align-items-center">
                                        <a class="media-left mr-50" href="javascript:;">
                                        <img src="{{asset('admin/images/portrait/small/avatar-s-9.jpg')}}" alt="avatar"
                                            class="rounded-circle" height="30" width="30">
                                        </a>
                                        <div class="media-body">
                                ...
                                <tr>
                                    ...
                                    <div class="media align-items-center">
                                        <a class="media-left mr-50" href="javascript:;">
                                        <img src="{{asset('admin/images/portrait/small/avatar-s-12.jpg')}}" alt="avatar"
                                            class="rounded-circle" height="30" width="30">
                                        </a>
                                        <div class="media-body">
                                        <h6 class="media-heading mb-0">Lula Taylor</h6>
                        ...
                        <div class="wrapper-content" data-earnings="admin-theme">
                            ...
                            <table class="table table-borderless widget-earnings-width mb-0">
                                ...
                                <tr>
                                    ...
                                    <div class="media align-items-center">
                                        <a class="media-left mr-50" href="javascript:;">
                                        <img src="{{asset('admin/images/portrait/small/avatar-s-25.jpg')}}" alt="avatar"
                                            class="rounded-circle" height="30" width="30">
                                        </a>
                                        <div class="media-body">
                                ...
                                <tr>
                                    ...
                                    <div class="media align-items-center">
                                        <a class="media-left mr-50" href="javascript:;">
                                        <img src="{{asset('admin/images/portrait/small/avatar-s-15.jpg')}}" alt="avatar"
                                            class="rounded-circle" height="30" width="30">
                                        </a>
                                        <div class="media-body">
                                        <h6 class="media-heading mb-0">Pauly Dez</h6>
                        ...
                        <div class="wrapper-content" data-earnings="ux-developer">
                            ...
                            <table class="table table-borderless widget-earnings-width mb-0">
                                ...
                                <tr>
                                    ...
                                    <div class="media align-items-center">
                                        <a class="media-left mr-50" href="javascript:;">
                                        <img src="{{asset('admin/images/portrait/small/avatar-s-16.jpg')}}" alt="avatar"
                                            class="rounded-circle" height="30" width="30">
                                        </a>
                                        <div class="media-body">
                                ...
                                <tr>
                                    ...
                                    <div class="media align-items-center">
                                        <a class="media-left mr-50" href="javascript:;">
                                        <img src="{{asset('admin/images/portrait/small/avatar-s-1.jpg')}}" alt="avatar"
                                            class="rounded-circle" height="30" width="30">
                                        </a>
                                        <div class="media-body">
                                        <h6 class="media-heading mb-0">Pauly Dez</h6>
                                ...
                                <tr>
                                    ...
                                    <div class="media align-items-center">
                                        <a class="media-left mr-50" href="javascript:;">
                                        <img src="{{asset('admin/images/portrait/small/avatar-s-2.jpg')}}" alt="avatar"
                                            class="rounded-circle" height="30" width="30">
                                        </a>
                                        <div class="media-body">
                        ...
                        <div class="wrapper-content" data-earnings="marketing-guide">
                            ...
                            <table class="table table-borderless widget-earnings-width mb-0">
                                ...
                                <tr>
                                    ...
                                    <div class="media align-items-center">
                                        <a class="media-left mr-50" href="javascript:;">
                                        <img src="{{asset('admin/images/portrait/small/avatar-s-19.jpg')}}" alt="avatar"
                                            class="rounded-circle" height="30" width="30">
                                        </a>
                                        <div class="media-body">
                    ...
                    <div class="card marketing-campaigns">
                        ...
                        <table id="table-marketing-campaigns" class="table table-borderless table-marketing-campaigns mb-0">
                            ...
                            <tr>
                                ...
                                <img class="rounded-circle mr-1" src="{{asset('admin/images/icon/fs.png')}}" alt="card" height="24"
                            ...
                            <tr>
                                <td class="py-1 line-ellipsis">
                                <img class="rounded-circle mr-1" src="{{asset('admin/images/icon/puma.png')}}" alt="card" height="24"
                                    width="24">Puma Shoes
                                </td>
                                <td class="py-1">
                            ...
                            <tr>
                                <td class="py-1 line-ellipsis">
                                <img class="rounded-circle mr-1" src="{{asset('admin/images/icon/nike.png')}}" alt="card" height="24"
                            ...
                            <tr>
                                <td class="py-1 line-ellipsis">
                                <img class="rounded-circle mr-1" src="{{asset('admin/images/icon/one-plus.png')}}" alt="card"
                            ...
                            <tr>
                                <td class="py-1 line-ellipsis">
                                <img class="rounded-circle mr-1" src="{{asset('admin/images/icon/google.png')}}" alt="card"
