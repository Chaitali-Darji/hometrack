                          ...
                          <div class="row">
                            <div class="col-md-6">
                              ...
                              <fieldset class="form-group">
                                ...
                                {!! Form::text('client[first_name]',null, array('class' => 'form-control', 'required' => true)) !!}
                              ...
                              <fieldset class="form-group">
                                ...
                                {!! Form::text('client[last_name]', null, array('class' => 'form-control', 'required' => true)) !!}
                              ...
                              <fieldset class="form-group">
                                ...
                                {!! Form::text('client[brokerage]', null, array('class' => 'form-control', 'required' => true)) !!}
                              ...
                              <fieldset class="form-group">
                                ...
                                {!! Form::text('client[mrisid]', null, array('class' => 'form-control', 'required' => true)) !!}
                                 @error('client.mrisid')
                                      <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
                              ...
                              <fieldset class="form-group">
                                ...
                                {!! Form::text('client[mobile_phone]', null, array('class' => 'form-control phone-number', 'required' => true)) !!}
                              ...
                              <fieldset class="form-group">
                                ...
                                {!! Form::text('client[office_phone]', null, array('class' => 'form-control phone-number', 'required' => true)) !!}
                               ...
                               <fieldset class="form-group">
                                ...
                                {!! Form::email('client[email]', null, array('class' => 'form-control', 'required' => true)) !!}
                                @error('client.office_phone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                               ...
                               <fieldset class="form-group">
                                ...
                                {!! Form::text('client[team_emails]', null, array('class' => 'form-control','data-role'=>"tagsinput",'id' => 'team-email-tag', 'required' => true)) !!}
                              ...
                              <fieldset class="form-group">
                                ...
                                {!! Form::text('client[website]', null, array('class' => 'form-control', 'required' => true)) !!}
                              ...
                              <fieldset class="form-group">
                                ...
                                {!! Form::textarea('client[notes]', null, array('class' => 'form-control')) !!}
                                @error('client.notes]')
                                    <span class="invalid-feedback" role="aler">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                              ...
                              <fieldset class="form-group">
                                ...
                                {!! Form::text('address[address1]', null, array('class' => 'form-control','id' => 'address1', 'required' => true)) !!}
...
@section('page-script')
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key={{env('GOOGLE_API_KEY')}}&callback=initAutocomplete&libraries=places&v=weekly"
      async></script>
@endsection